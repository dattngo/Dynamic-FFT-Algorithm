...
# DVE full session
# Saved on Wed Nov 4 19:09:04 2015
# Designs open: 1
...
#<Session mode="Full" path="/home/ThanhDat/Work/01_Project/01_FFT/FFT_cla/02_simulate/run/DVEfiles/session.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{5 24} {1892 1002}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 441} {height 679} {show_state normal} {dock_state left} {dock_on_new_line true} {child_hier_colhier 352} {child_hier_coltype 100} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 679
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 429} {height 679} {show_state normal} {dock_state left} {dock_on_new_line true} {child_data_colvariable 217} {child_data_colvalue 100} {child_data_coltype 122} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2} {dataShowMode detail} {max_item_length 50}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1887} {height 173} {show_state normal} {dock_state bottom} {dock_on_new_line true}}
